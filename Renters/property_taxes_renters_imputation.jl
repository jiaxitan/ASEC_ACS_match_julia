...
select!(df_ACS_renters, Not(:txrate))

include("/Users/jiaxitan/UMN/Fed RA/Heathcote/Property Tax Est/Property-Tax-Imputing/Renters/fit_proptxrate_income.jl");
fit_proptxrate_income_ACS!();

insertcols!(df_ACS_renters, :proptx => df_ACS_renters.txrate .* df_ACS_renters.valueh_renters_mean);

df_ACS_renters.proptx99_recode = copy(df_ACS_renters.proptx);
